...
SYSTEM_SETTINGS_METADATA: dict[str, dict[str, Any]] = {
    ...
    "PUBLISH_MIN_FUTURE_BUFFER_MINUTES": {
        ...
        "min_value": 0,
        "max_value": 1440,
        "description": "Jarak minimum publikasi dari sekarang untuk post segera (menit)",
    },
    "PUBLISH_BATCH_MAX_CLIPS": {
        ...
        "min_value": 1,
        "max_value": 200,
        "description": "Jumlah maksimum clip dalam satu batch publish",
    },
    "PUBLISH_CAPTION_MAX_CHARS": {
        ...
        "min_value": 100,
        "max_value": 10000,
        "description": "Batas karakter caption sebelum dikirim ke Repliz",
    },
    "PUBLISH_DEFAULT_MUSIC_VOLUME": {
        ...
        "min_value": 0.0,
        "max_value": 1.0,
        "description": "Volume musik default API (0.0 sampai 1.0) jika client tidak mengirim nilai",
    },
    "PUBLISH_DEFAULT_ORIGINAL_VOLUME": {
        ...
        "min_value": 0.0,
        "max_value": 1.0,
        "description": "Volume audio asli default API (0.0 sampai 1.0) jika client tidak mengirim nilai",
    },
}
