...
class GoogleDriveUploader:
    ...
    def upload_video(
        ...
        # Direct download link (usable by Repliz, Meta/Instagram, and TikTok)
        # lh3.googleusercontent.com/d/{file_id} serves raw binary media with Accept-Ranges: bytes
        # and eliminates the 2.4KB Google Drive virus scan HTML warning page.
        ...
        logger.info(f"Google Drive video file shared publicly: {direct_link}")
    ...
    def upload_image(
        ...
        """Upload an image (thumbnail/cover) file to Google Drive.
        ...
        file_id = file.get("id")
        logger.info(f"Google Drive image upload complete: {file_name} -> {file_id}")
