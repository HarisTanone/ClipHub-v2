...
def _format_user_preset_row(row) -> Dict[str, Any]:
    ...
    return {
        ...
        "broll_image_overlay": bool(broll_style.get("image_overlay", False)) if broll_style else False,
        "broll_behind_person": bool(broll_style.get("behind_person", False)) if broll_style else False,
        "broll_video_footage": bool(broll_style.get("video_footage", False)) if broll_style else False,
