...
class JobRepository(IJobRepository):
    ...
    def _to_entity(self, model: JobModel) -> Job:
        return Job(
            ...
            broll_image_overlay=bool((model.clips_data or {}).get("broll_image_overlay", True)) if bool(model.broll_enabled) else False,
            broll_behind_person=bool((model.clips_data or {}).get("broll_behind_person", True)) if bool(model.broll_enabled) else False,
            broll_video_footage=bool((model.clips_data or {}).get("broll_video_footage", True)) if bool(model.broll_enabled) else False,
