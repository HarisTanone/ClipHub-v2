...
async def create_job(
    ...
    job, is_cached = await service.create_job(
        ...
        broll_image_overlay=request.broll_image_overlay,
        broll_behind_person=request.broll_behind_person,
        broll_video_footage=request.broll_video_footage,
...
async def create_job_from_upload(
    ...
    try:
        ...
        job, is_cached = await service.create_job(
            ...
            broll_image_overlay=options.broll_image_overlay,
            broll_behind_person=options.broll_behind_person,
            broll_video_footage=options.broll_video_footage,
            broll_motion_style=options.broll_motion_style,
            text_emphasis_enabled=options.text_emphasis_enabled,
...
async def get_job_detail(
    ...
    for clip in clip_candidates:
        ...
        clips_info.append({
            ...
            "hyperframes_polish": clip.get("hyperframes_polish"),
...
async def reprocess_job(
    ...
    fresh, _ = await service.create_job(
        ...
        text_emphasis_enabled=bool((old.clips_data or {}).get("text_emphasis_enabled", False)),
        ...
        background_image_data_url=(old.clips_data or {}).get("background_image_data_url"),
        user_id=user.id,
        is_superadmin=user.is_superadmin,
        source_type=source_type,
...
async def restyle_clip(
    ...
    try:
        ...
        enriched_sub_config["autogrid_enabled"] = bool(getattr(job, "autogrid_enabled", False))
