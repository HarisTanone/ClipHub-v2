...
if [ -f ".env" ]; then
    ...
    append_env_if_missing ".env" "TOP_OVERLAY_SPLIT_RATIO" "0.64"
    ...
    append_env_if_missing ".env" "TOP_OVERLAY_OUTLINE_THICKNESS" "10"
    ...
    append_env_if_missing ".env" "TOP_OVERLAY_PERSON_SCALE" "0.82"
    append_env_if_missing ".env" "TOP_OVERLAY_PERSON_SHIFT_Y" "0.30"
    append_env_if_missing ".env" "TOP_OVERLAY_OUTLINE_BUST_RATIO" "0.48"
    append_env_if_missing ".env" "TOP_OVERLAY_OUTLINE_EDGE_MARGIN" "0.04"
