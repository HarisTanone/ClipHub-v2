...
if [ -f ".env" ]; then
    ...
    append_env_if_missing ".env" "TOP_OVERLAY_SPLIT_RATIO" "0.68"
    append_env_if_missing ".env" "TOP_OVERLAY_FADE_HEIGHT" "0.12"
    ...
    append_env_if_missing ".env" "TOP_OVERLAY_PERSON_SCALE" "0.80"
    append_env_if_missing ".env" "TOP_OVERLAY_PERSON_SHIFT_Y" "0.12"
    append_env_if_missing ".env" "TOP_OVERLAY_PERSON_ANCHOR" "natural"
    append_env_if_missing ".env" "TOP_OVERLAY_PERSON_EDGE_MARGIN" "0.03"
    append_env_if_missing ".env" "TOP_OVERLAY_BG_BLACK" "0.55"
