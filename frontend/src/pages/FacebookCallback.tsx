 ...
 * Opened in a popup by FacebookConnectFlow — extracts the code from URL params
...
export function FacebookCallback() {
  useEffect(() => {
    ...
    if (code && window.opener) {
      window.opener.postMessage({ type: "facebook-oauth-callback", code }, window.location.origin);
      window.close();
    }
  }, []);
  ...
  return (
    <div className="min-h-screen bg-[#09090b] flex items-center justify-center">
      <div className="text-center">
        ...
        <p className="text-sm text-zinc-400">Connecting Facebook account...</p>
