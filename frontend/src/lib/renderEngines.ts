...
export const SKIA_SUBTITLE_PRESETS: SkiaSubtitlePreset[] = [
  ...
  },
  {
    id: "nordic_minimal",
    name: "Nordic Minimal",
    desc: "Understated Scandinavian aesthetic: muted slate to crisp white with smooth line tracking.",
    category: "clean",
    color: "#94A3B8",
  ...
  },
  {
    ...
    desc: "Floating clean typography with zero background clutter, maximum readability drop shadow.",
    category: "clean",
    color: "#FFFFFF",
