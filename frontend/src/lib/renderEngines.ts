...
export const HF_HOOK_STYLES: HfStylePreset[] = [
  ...
  },
  {
    ...
    mood: "Cyberpunk",
    accent: "#00F0FF",
    desc: "Tech HUD digital box · neon cyan brackets",
    preview: "SYSTEM BREACH",
  },
  {
    ...
    mood: "Glass",
    accent: "#A78BFA",
    desc: "Frosted glass card · subtle ambient glow",
    preview: "MODERN INSIGHT",
  },
  {
    ...
    mood: "News",
    accent: "#EF4444",
    desc: "Red breaking news banner · live badge",
  ...
  },
  {
    ...
    mood: "Synthwave",
    accent: "#F43F5E",
    desc: "80s neon synthwave · pink & purple glow",
    preview: "NIGHT DRIVE",
  },
  {
    id: "hook_comic_pop",
    ...
    mood: "Pop-Art",
    accent: "#FACC15",
    desc: "Tilted comic badge · bold pop-art action",
    preview: "POW! RAHASIA",
  },
  {
    ...
    mood: "Editorial",
    accent: "#E2E8F0",
    desc: "Matte black pill · gold dot typography",
    preview: "KEY PERSPECTIVE",
  },
  {
    id: "hook_gradient_aura",
    name: "Gradient Aura Glow",
    kind: "hook",
    mood: "Aura",
    accent: "#38BDF8",
    desc: "Multi-color mesh aura · smooth glow",
    preview: "FUTURE SHIFT",
  },
  {
    id: "hook_cinema_tape",
    ...
    mood: "Industrial",
    accent: "#EAB308",
    desc: "Hazard stencil tape · industrial warning",
    preview: "CAUTION: WATCH",
  },
  {
    ...
    mood: "Sci-Fi",
    accent: "#06B6D4",
    desc: "Holographic data feed · vertical scanner",
  ...
  },
  {
    ...
    mood: "Luxury",
    accent: "#D4AF37",
    desc: "Obsidian dark card · champagne gold trim",
  ...
  },
  {
    ...
    mood: "Badge",
    accent: "#10B981",
    desc: "Floating top corner badge · live indicator",
  ...
  },
  {
    ...
    mood: "Kinetic",
    accent: "#F97316",
    desc: "Split orange & black block · kinetic counter",
    preview: "PART 1: THE TRUTH",
  },
  {
    id: "hook_neon_matrix",
    name: "Matrix Rain Cyber Term",
    kind: "hook",
    mood: "Matrix",
    accent: "#10B981",
    desc: "Terminal green phosphor · cyber prompt box",
    preview: "ALERT: JANGAN SKIP",
  },
  {
    ...
    mood: "Hazard",
    accent: "#F59E0B",
    desc: "Heavy hazard stripes · alert hazard badge",
    preview: "WARNING: INI PENTING",
  },
  {
    id: "hook_sticker_scrapbook",
    name: "Y2K Scrapbook Sticker",
    kind: "hook",
    mood: "Scrapbook",
    accent: "#EC4899",
  ...
  },
  {
    ...
    name: "Ultra Modern Serif Slate",
    kind: "hook",
    mood: "Cinematic",
    accent: "#F8FAFC",
    desc: "Titanium serif slate · gold hairline rules",
    preview: "THE UNTOLD TRUTH",
  },
  {
